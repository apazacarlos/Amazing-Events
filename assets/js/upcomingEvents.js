async function getEventsData() {
    try {
        ...
        //Armo las cartas dinamicamente (preguntando si la fecha del evento es despues que la fecha actual) con el array de eventos y el contenedor que los va a contener como parametro. 
        ...
        function dibujarCard(arrayE, container) {
            ...
            for (let evento of arrayE) {
                ...
                if (eventDate > currentDate) {
                    ...
                    divCard.innerHTML += `<img src="${evento.image}" class="card-img-top" alt="${evento.name}">
                    <div class="card-body">
